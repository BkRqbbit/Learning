...
It is recommended that you use one of the most popular web browsers on the market, they follow the web recommendastions, which garantees you as a web developer, that how you see your web page on that browser, will look equal or similar on other ones.\
Also consider that top browsers are what users use.
...
It is always recommended that you learn html using a basic text editor, just to get familiear with the sintax, and identify ints elemtns.\
